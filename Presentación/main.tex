...
{\tiny \gris{El modelo entero completo ---variables $x_{ij}$, restricciones de grado y
cortes RCI--- está en el \textbf{anexo} del final.}}
\column{0.06\textwidth}
\column{0.54\textwidth}
\begin{block}{Datos}
\scriptsize
$V=\{1,\dots,n\}$ nodos ($1$ = depósito); $c_{ij}$ costo de la arista $\{i,j\}$;
$d_i\ge 0$ demanda del cliente $i$; flota de $m$ vehículos de capacidad $D$.
\end{block}
