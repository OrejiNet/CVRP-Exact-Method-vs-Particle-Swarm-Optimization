...
parametrización, experimentación y análisis) está disponible en un repositorio
público\footnote{\url{https://github.com/OrejiNet/CVRP-Exact-Method-vs-Particle-Swarm-Optimization}}.
